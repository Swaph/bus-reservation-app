...
function bookSeats() {
    ...
    console.log('Booking seats:', { route, date, seats: Object.keys(passengerInfoData), passengerInfo: passengerInfoData });
    ...
    fetch('/api/reserve-seat', {
        ...
        body: JSON.stringify({ route, date, seats: Object.keys(passengerInfoData), passengerInfo: passengerInfoData })
    })
        .then(response => response.json())
        .then(data => {
